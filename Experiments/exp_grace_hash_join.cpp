...
int main()
{
	...
	exps.push_back( Experiment::random_writes_on_the_side_experiment(grace_hash_join_flex(grace_space),	  write_threads_min, write_threads_max, 1, exp_folder + "Flexible_reads/", "Flexible reads",        IO_limit, logical_space, noise_space_min, noise_space_max) );
	exps.push_back( Experiment::random_writes_on_the_side_experiment(grace_hash_join(grace_space),		  write_threads_min, write_threads_max, 1, exp_folder + "None/", "None",                  			IO_limit, logical_space, noise_space_min, noise_space_max) );
