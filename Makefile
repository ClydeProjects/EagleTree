...
SRC = ssd_address.cpp ssd_block.cpp ssd_bus.cpp ssd_channel.cpp ssd_config.cpp ssd_controller.cpp ssd_die.cpp ssd_event.cpp ssd_package.cpp ssd_page.cpp ssd_plane.cpp ssd_ram.cpp ssd_ssd.cpp ssd_bm.cpp ssd_stats.cpp page_ftl.cpp bast_ftl.cpp fast_ftl.cpp bdftl_ftl.cpp dftl_ftl.cpp ssd_ftlparent.cpp dftl_parent.cpp ssd_raidssd.cpp ssd_io_scheduler.cpp ssd_bm_parallel.cpp ssd_page_hotness_measurer.cpp ssd_block_manager_wearwolf.cpp ssd_block_manager_wearwolf_locality.cpp  ssd_block_manager_hot_cold_seperation.cpp ssd_block_manager_parent.cpp ssd_visual_tracer.cpp
OBJ = ssd_address.o ssd_block.o ssd_bus.o ssd_channel.o ssd_config.o ssd_controller.o ssd_die.o ssd_event.o ssd_package.o ssd_page.o ssd_plane.o ssd_ram.o ssd_ssd.o ssd_bm.o ssd_stats.o page_ftl.o bast_ftl.o fast_ftl.o bdftl_ftl.o dftl_ftl.o ssd_ftlparent.o dftl_parent.o ssd_raidssd.o ssd_io_scheduler.o ssd_bm_parallel.o ssd_page_hotness_measurer.o ssd_block_manager_wearwolf.o ssd_block_manager_wearwolf_locality.o ssd_block_manager_hot_cold_seperation.o ssd_block_manager_parent.o ssd_visual_tracer.o
LOG = log
PERMS = 660
EPERMS = 770
