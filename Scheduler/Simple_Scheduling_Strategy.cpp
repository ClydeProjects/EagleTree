...
void Smart_Priorty_Scheme::schedule(vector<Event*> reads, vector<Event*> copyback_commands, vector<Event*> writes, vector<Event*> erases) {
...
void Smart_GC_Priorty_Scheme::schedule(vector<Event*> reads, vector<Event*> copyback_commands, vector<Event*> writes, vector<Event*> erases) {
