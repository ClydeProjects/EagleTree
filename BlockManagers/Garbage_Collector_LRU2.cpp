...
Garbage_Collector_LRU2::Garbage_Collector_LRU2()
	:  Garbage_Collector(),
	   gc_candidates(SSD_SIZE, vector<queue<int> >(PACKAGE_SIZE))
{}

Garbage_Collector_LRU2::Garbage_Collector_LRU2(Ssd* ssd, Block_manager_parent* bm)
...
Block* Garbage_Collector_LRU2::choose_gc_victim(int package_id, int die_id, int klass) const {
