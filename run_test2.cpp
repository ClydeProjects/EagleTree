...
void experiement2() {
	vector<Thread*> threads;
	Thread* t1 = new Asynchronous_Sequential_Thread(0, 199, 1, WRITE,16);
	Thread* t2 = new Asynchronous_Sequential_Thread(200, 399, 1, WRITE, 16);
	Thread* t3 = new Asynchronous_Sequential_Thread(400, 599, 1, WRITE, 16);
	Thread* t4 = new Asynchronous_Sequential_Thread(600, 799, 1, WRITE, 16);

	t1->add_follow_up_thread(new Asynchronous_Random_Thread(0, 199, 500, 1, WRITE, 20, 1));
	t2->add_follow_up_thread(new Asynchronous_Random_Thread(200, 399, 500, 2, WRITE, 20, 2));
	t3->add_follow_up_thread(new Asynchronous_Random_Thread(400, 599, 500, 3, WRITE, 20, 3));
	t4->add_follow_up_thread(new Asynchronous_Random_Thread(600, 799, 500, 4, WRITE, 20, 4));
